...
import { useSearchNav, searchNavDataType } from "@/contexts/SearchNavContext"
  ...
  return (
    <form className="max-w-md mx-auto">
      ...
      <div className="relative">
        ...
        <input type="search" id="searchTerm" value={searchTerm} onChange={(e) => setSearchAndContext(e.target.value)} className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos..." required />
        <button type="submit" onClick={() => {
          callback(searchNavData)
